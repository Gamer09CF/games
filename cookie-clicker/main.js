	...
	Game.Init=function()
	{
		...
		if (Game.beta) {
			...
			if (me && me.parentNode) {
				...
				console.log("linkVersionBeta element not found or already removed.");
			}
			...
			if (me && me.parentNode) {
				...
				console.log("linkVersionOld element not found or already removed.");
			}
		} else {
			...
			if (me && me.parentNode) {
				...
				console.log("linkVersionLive element not found or already removed.");
			}
		}
